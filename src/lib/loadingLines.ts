...
const ALL_LINES = [
  ...
  // more app / general
  "Practicing the loading dance...",
  "Buffering vibes...",
  "Shuffling the deck of records...",
  "Hand-knitting your UI...",
  "Consulting the loading council...",
  "Greasing the squeaky wheels of progress...",
  "Fetching data at a dignified pace...",
  "Reassuring the JSON that it matters...",
  "Calibrating the enthusiasm dial...",
  "Reticulating splines...",
  "Translating data from ancient binary...",
  "Negotiating with the garbage collector...",
  "Lining up the zeros and ones...",
  "Coaxing the data out of its shell...",
  // more inventory
  "Taking attendance in the supply closet...",
  "Checking if anything walked off...",
  "Searching behind the metaphorical cabinets...",
  "Asking the shelves how they're feeling today...",
  "Listening for rustling in the stockroom...",
  "Whispering to the barcode gods...",
  "Renumbering the bins for fun...",
  "Giving each box a hug...",
  "Counting on fingers, then on toes...",
  // reorder / orders
  "Drafting a sternly-worded reorder list...",
  "Checking the vendor is still speaking to us...",
  "Boxing up the box count...",
  "Doing the reorder math by hand...",
  "Adding items to the cart with ceremony...",
  "Alphabetizing vendors by vibes...",
  "Calculating how much is too much...",
  "Preparing the receipt drumroll...",
  // settings / users
  "Assigning permission stickers...",
  "Polishing everyone's name tag...",
  "Double-knotting the access controls...",
  "Rehearsing the welcome email...",
  // billing
  "Telling Stripe we meant it...",
  "Balancing the books with a spirit level...",
  "Counting the nickels...",
];
