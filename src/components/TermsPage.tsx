  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <p>
          We are Wired Wick Consulting LLC, doing business as WickOps
          (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company registered in
          Montana, United States at 407 St Mary Dr, Stevensville, MT 59870.
        </p>
        ...
        <p>
          WickOps is a cloud-based inventory management platform designed for fire departments and
          small organizations. It enables users to track inventory, log usage, manage reorders,
          monitor expiration dates, and generate activity reports through a web-based application
          accessible on desktop and mobile devices.
        </p>

        <p>
          You can contact us by phone at (530)613-9910, email at{" "}
          <a href="mailto:wickopsmanager@gmail.com">wickopsmanager@gmail.com</a>, or by mail to
          407 St Mary Dr, Stevensville, MT 59870, United States.
        </p>

        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity (&quot;you&quot;), and Wired Wick Consulting LLC,
        ...
        <p>
          ...
          <a href="mailto:wickopsmanager@gmail.com">wickopsmanager@gmail.com</a>, as stated in the
          email message. By continuing to use the Services after the effective date of any changes,
        ...
        <ol className="legal-toc">
          <li><a href="#tos-services">OUR SERVICES</a></li>
          <li><a href="#tos-ip">INTELLECTUAL PROPERTY RIGHTS</a></li>
          <li><a href="#tos-userreps">USER REPRESENTATIONS</a></li>
          <li><a href="#tos-userreg">USER REGISTRATION</a></li>
          <li><a href="#tos-purchases">PURCHASES AND PAYMENT</a></li>
          <li><a href="#tos-subscriptions">SUBSCRIPTIONS</a></li>
          <li><a href="#tos-prohibited">PROHIBITED ACTIVITIES</a></li>
          <li><a href="#tos-ugc">USER GENERATED CONTRIBUTIONS</a></li>
          <li><a href="#tos-license">CONTRIBUTION LICENSE</a></li>
          <li><a href="#tos-thirdparty">THIRD-PARTY WEBSITES AND CONTENT</a></li>
          <li><a href="#tos-sitemanage">SERVICES MANAGEMENT</a></li>
          <li><a href="#tos-privacy">PRIVACY POLICY</a></li>
          <li><a href="#tos-copyright">COPYRIGHT INFRINGEMENTS</a></li>
          <li><a href="#tos-terms">TERM AND TERMINATION</a></li>
          <li><a href="#tos-modifications">MODIFICATIONS AND INTERRUPTIONS</a></li>
          <li><a href="#tos-law">GOVERNING LAW</a></li>
          <li><a href="#tos-disputes">DISPUTE RESOLUTION</a></li>
          <li><a href="#tos-corrections">CORRECTIONS</a></li>
          <li><a href="#tos-disclaimer">DISCLAIMER</a></li>
          <li><a href="#tos-liability">LIMITATIONS OF LIABILITY</a></li>
          <li><a href="#tos-indemnification">INDEMNIFICATION</a></li>
          <li><a href="#tos-userdata">USER DATA</a></li>
          <li><a href="#tos-electronic">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
          <li><a href="#tos-california">CALIFORNIA USERS AND RESIDENTS</a></li>
          <li><a href="#tos-misc">MISCELLANEOUS</a></li>
          <li><a href="#tos-dataownership">DATA OWNERSHIP AND PORTABILITY</a></li>
          <li><a href="#tos-contact">CONTACT US</a></li>
        </ol>

        {/* ── 1. OUR SERVICES ────────────────────────────────────────── */}
        <h2 id="tos-services">1. OUR SERVICES</h2>
        <p>
        ...
        <h2 id="tos-ip">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        ...
        <p>
          ...
          <a href="#tos-prohibited">PROHIBITED ACTIVITIES</a> section below, we grant you a
        ...
        <p>
          ...
          <a href="mailto:wickopsmanager@gmail.com">wickopsmanager@gmail.com</a>. If we ever grant
        ...
        <p>
          Please review this section and the <a href="#tos-prohibited">PROHIBITED ACTIVITIES</a>{" "}
        ...
        <ul>
          <li>
            ...
            <a href="#tos-prohibited">PROHIBITED ACTIVITIES</a> and will not post, send, publish,
            upload, or transmit through the Services any Submission nor post any Contribution that is
        ...
        <p>
          ...
          <a href="#tos-copyright">COPYRIGHT INFRINGEMENTS</a> section below.
        </p>

        {/* ── 3. USER REPRESENTATIONS ────────────────────────────────── */}
        <h2 id="tos-userreps">3. USER REPRESENTATIONS</h2>
        ...
        {/* ── 4. USER REGISTRATION ───────────────────────────────────── */}
        <h2 id="tos-userreg">4. USER REGISTRATION</h2>
        <p>
        ...
        <h2 id="tos-purchases">5. PURCHASES AND PAYMENT</h2>
        ...
        {/* ── 6. SUBSCRIPTIONS ───────────────────────────────────────── */}
        <h2 id="tos-subscriptions">6. SUBSCRIPTIONS</h2>
        ...
        <p>
          ...
          for each recurring charge, until such time as you cancel the applicable order. The length
          of your billing cycle will depend on the type of subscription plan you choose when you
        ...
        <h2 id="tos-prohibited">7. PROHIBITED ACTIVITIES</h2>
        <p>
        ...
        <h2 id="tos-ugc">8. USER GENERATED CONTRIBUTIONS</h2>
        <p>
        ...
        <h2 id="tos-license">9. CONTRIBUTION LICENSE</h2>
        <p>
        ...
        <h2 id="tos-thirdparty">10. THIRD-PARTY WEBSITES AND CONTENT</h2>
        <p>
          ...
          Third-Party Content posted on, available through, or installed from the Services, including
        ...
        <h2 id="tos-sitemanage">11. SERVICES MANAGEMENT</h2>
        <p>
        ...
        {/* ── 12. PRIVACY POLICY ─────────────────────────────────────── */}
        <h2 id="tos-privacy">12. PRIVACY POLICY</h2>
        <p>
        ...
        <h2 id="tos-copyright">13. COPYRIGHT INFRINGEMENTS</h2>
        <p>
          We respect the intellectual property rights of others. If you believe that any material
          available on or through the Services infringes upon any copyright you own or control,
          ...
          or linked to by the Services infringes your copyright, you should consider first contacting
          an attorney.
        </p>

        {/* ── 14. TERM AND TERMINATION ───────────────────────────────── */}
        <h2 id="tos-terms">14. TERM AND TERMINATION</h2>
        <p>
          ...
          TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT
        ...
        <h2 id="tos-modifications">15. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p>
        ...
        {/* ── 16. GOVERNING LAW ──────────────────────────────────────── */}
        <h2 id="tos-law">16. GOVERNING LAW</h2>
        <p>
          These Legal Terms and your use of the Services are governed by and construed in accordance
          with the laws of the State of Montana applicable to agreements made and to be entirely
          performed within the State of Montana, without regard to its conflict of law principles.
        </p>

        {/* ── 17. DISPUTE RESOLUTION ─────────────────────────────────── */}
        <h2 id="tos-disputes">17. DISPUTE RESOLUTION</h2>
        ...
        <p>
          ...
          (30) days before initiating arbitration. Such informal negotiations commence upon written
        ...
        <p>
          ...
          online. The arbitrator will make a decision in writing, but need not provide a statement
          ...
          Ravalli, Montana. Except as otherwise provided herein, the Parties may litigate in court
          to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate,
        ...
        <p>
          ...
          be commenced or prosecuted in the state and federal courts located in Ravalli, Montana, and
        ...
        {/* ── 18. CORRECTIONS ────────────────────────────────────────── */}
        <h2 id="tos-corrections">18. CORRECTIONS</h2>
        <p>
        ...
        {/* ── 19. DISCLAIMER ─────────────────────────────────────────── */}
        <h2 id="tos-disclaimer">19. DISCLAIMER</h2>
        <p>
          ...
          THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, (5)
        ...
        <h2 id="tos-liability">20. LIMITATIONS OF LIABILITY</h2>
        <p>
          ...
          BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR
          TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
        ...
        {/* ── 21. INDEMNIFICATION ────────────────────────────────────── */}
        <h2 id="tos-indemnification">21. INDEMNIFICATION</h2>
        <p>
        ...
        {/* ── 22. USER DATA ──────────────────────────────────────────── */}
        <h2 id="tos-userdata">22. USER DATA</h2>
        <p>
        ...
        <h2 id="tos-california">24. CALIFORNIA USERS AND RESIDENTS</h2>
        <p>
        ...
        {/* ── 25. MISCELLANEOUS ──────────────────────────────────────── */}
        <h2 id="tos-misc">25. MISCELLANEOUS</h2>
        <p>
        ...
        {/* ── 26. DATA OWNERSHIP AND PORTABILITY ─────────────────────── */}
        <h2 id="tos-dataownership">26. DATA OWNERSHIP AND PORTABILITY</h2>
        <p>
          All inventory data, usage records, and operational data entered into the platform by the
          customer remains the sole property of the customer. Wired Wick Consulting LLC does not
          sell, share, or use customer data for any purpose other than providing the Services. Upon
          cancellation or termination, customer data will be available for export for 30 days, after
          which it will be permanently deleted. Consulting and onboarding fees are non-refundable as
          they represent services already rendered.
        </p>

        {/* ── 27. CONTACT US ─────────────────────────────────────────── */}
        <h2 id="tos-contact">27. CONTACT US</h2>
        <p>
